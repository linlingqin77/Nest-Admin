    ...
    type Schema = {
      ...
      page: {
        ...
        fileManager: {
          ...
          folderRenameNotImplemented: string;
          pleaseSelectItemsToDelete: string;
          pleaseSelectFilesToMove: string;
          cannotMoveFolders: string;
          pleaseSelectFilesToShare: string;
          cannotShareFolders: string;
          pleaseSelectFilesToDownload: string;
          batchDownloadNotImplemented: string;
          sharedNotImplemented: string;
          recentNotImplemented: string;
          pauseUploadNotImplemented: string;
          resumeUploadNotImplemented: string;
          retryUploadNotImplemented: string;
        };
      };
      form: {
        required: string;
